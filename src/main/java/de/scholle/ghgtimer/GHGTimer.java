...
public class GHGTimer extends JavaPlugin implements TabExecutor {
    ...
    public void onEnable() {
        saveDefaultConfig();
        loadConfigValues();
        getCommand("ghgtimer").setExecutor(this);
        getCommand("ghgtimer").setTabCompleter(this);
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (!sender.hasPermission("GHGTimer.op")) {
        ...
        switch (args[0].toLowerCase()) {
            ...
            case "colour" -> {
                if (args.length < 2) {
                    sender.sendMessage(ChatColor.RED + "Usage: /ghgtimer colour <color>");
                    return true;
                }
            ...
            case "goal" -> {
                if (args.length < 2) {
                    sender.sendMessage(ChatColor.RED + "Usage: /ghgtimer goal <advancement>");
                    return true;
                }
